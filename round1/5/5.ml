...
let extract_param s = List.map int_of_string(Str.split (Str.regexp " ") s);;
...
let resolve a = fin  (extract_param a);;

(* Exemple d'utilisation *)
(* jam "C-large-practice.in" "toto.out" lecture resolve;;*)
